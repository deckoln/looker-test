application: dashboard-summarization {
  ...
  entitlements: {
    ...
    external_api_urls: [
      "https://websocketserviceimage-555354526963.us-central1.run.app","http://localhost:5000","http://localhost:3000","https://*.googleapis.com","https://slack.com/api/*","https://slack.com/*"
    ]
    oauth2_urls: [
